...
-- 	}):wait()
-- 	vim.cmd.edit()
-- end, { buffer = true, desc = "format the entire buffer using black with string processing enabled" })
--
-- vim.keymap.set({ "n", "x" }, "<localleader>fr", function()
-- 	require("conform").format({
-- 		async = true,
-- 		lsp_fallback = true,
-- 		formatters = { "ruff_fix" },
-- 	})
-- end, { buffer = true, desc = "Format the current buffer by fixing all lints using ruff" })
