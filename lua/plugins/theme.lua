...
local function set_custom_highlights()
  ...
  hl(0, "StatuslineModeNormal", { fg = rose, bold = true })
  hl(0, "StatuslineModeOther", { fg = rose, bold = true })
  hl(0, "StatuslineModeReplace", { fg = pine, bold = true })
  hl(0, "StatuslineModeVisual", { fg = iris, bold = true })
  hl(0, "StatuslineTextAccent", { fg = muted })
  hl(0, "StatuslineTextMain", { fg = gold })

  -- mini.statusline (transparent bg, link mode groups to existing Statusline* colors)
  hl(0, "MiniStatuslineModeNormal", { link = "StatuslineModeNormal" })
  hl(0, "MiniStatuslineModeInsert", { link = "StatuslineModeInsert" })
  hl(0, "MiniStatuslineModeVisual", { link = "StatuslineModeVisual" })
  hl(0, "MiniStatuslineModeReplace", { link = "StatuslineModeReplace" })
  hl(0, "MiniStatuslineModeCommand", { link = "StatuslineModeCommand" })
  hl(0, "MiniStatuslineModeOther", { link = "StatuslineModeOther" })
  hl(0, "MiniStatuslineDevinfo", { fg = muted, bg = "NONE" })
  hl(0, "MiniStatuslineFilename", { fg = text, bg = "NONE" })
  hl(0, "MiniStatuslineFileinfo", { fg = subtle, bg = "NONE" })
  hl(0, "MiniStatuslineInactive", { fg = muted, bg = "NONE" })
