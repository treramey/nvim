			...
			require("catppuccin").setup({
				...
				custom_highlights = function(colors)
					return {
						...
						StatuslineLspOn = { fg = colors.flamingo, bg = colors.mantle },
						StatuslineFormatterStatus = { fg = colors.flamingo, bg = colors.mantle },
						StatuslineCopilot = { fg = colors.flamingo, bg = colors.mantle },
						StatuslineActiveHarpoon = { fg = colors.lavender, bg = colors.mantle },
